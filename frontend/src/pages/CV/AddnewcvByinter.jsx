...
<UserSidebar/>
      ...
      <div className=" w-fit  border-2 border-gray-200 rounded-lg p-4 m-4 ">
...
/>
  ...
  <input {...register("nic")} placeholder="NIC Number" className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white/30 backdrop-blur-md shadow-md focus:outline-none focus:ring-4 focus:ring-blue-400 focus:border-blue-500 transition duration-300 placeholder-gray-500 text-gray-900 dark:text-white dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-400" required />
...
<hr className="mb-6" />
          ...
          <input {...register("cvFile")} type="file" accept=".pdf" className="border p-2 rounded" required />
