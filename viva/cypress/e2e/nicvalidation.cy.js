describe('Intern Registration - NIC Validation', () => {
    it('Shows an error for invalid NIC format', () => {
      ...
      // Invalid NIC format
      cy.get('input[name="nic"]').type('123456789');
      ...
      cy.contains('Invalid NIC format').should('be.visible');
    });
  });
